...
public class Grouping {
  ...
  public static void main(String ... args) {
    ...
    System.out.println("Most caloric dishes by type using collectingAndThen: " + mostCaloricByType());
    System.out.println("Sum calories by type: " + sumCaloriesByType());
    System.out.println("Caloric levels by type: " + caloricLevelsByType());
    System.out.println("Caloric levels by type specific collection: " + caloricLevelsByTypeSpecificCollection());
  ...
  private static Map<Dish.Type, Set<CaloricLevel>> caloricLevelsByType() {
    ...
    private static Map<Dish.Type, Set<CaloricLevel>> caloricLevelsByTypeSpecificCollection () {
        return menu.stream().collect(
